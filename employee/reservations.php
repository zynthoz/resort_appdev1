...
$sql = "SELECT r.*, u.full_name, a.accommodation_name FROM tbl_reservations r JOIN tbl_users u ON r.user_id = u.user_id JOIN tbl_accommodations a ON r.accommodation_id = a.accommodation_id WHERE 1=1";
if ($search) $sql .= " AND u.full_name LIKE '%$search%'";
if ($status_filter) $sql .= " AND r.reservation_status = '$status_filter'";
$sql .= " ORDER BY r.check_in_date DESC";
$result = mysqli_query($conn, $sql);
?>
<?php include 'includes/sidebar.php'; ?>
<div class="main-content">
    <div class="page-header"><h1>Reservations</h1><p>Manage all guest reservations</p></div>

    <?php if (isset($_GET['msg'])): ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <?php if ($_GET['msg'] == 'approved') echo 'Reservation approved successfully.'; elseif ($_GET['msg'] == 'rejected') echo 'Reservation rejected.'; elseif ($_GET['msg'] == 'added') echo 'Reservation added successfully.'; ?>
    ...
    <div class="table-card">
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                <thead><tr><th>Customer</th><th>Accommodation</th><th>Check In</th><th>Check Out</th><th>Total</th><th>Status</th><th>Actions</th></tr></thead>
                <tbody>
                    ...
                    <?php endwhile; else: ?>
                    <tr><td colspan="7"><div class="empty-state"><h3>No reservations found</h3><p>Reservations will appear here once guests start booking.</p></div></td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
