...
<div class="main-content">
    <div class="page-header"><h1>Edit Amenity</h1><p>Update amenity details</p></div>
    <div class="form-card card">
        <div class="card-header"><h2>Amenity Details</h2></div>
        <div class="card-body">
            <form method="POST" action="">
                <div class="mb-3"><label for="amenity_name" class="form-label">Amenity Name</label><input type="text" class="form-control" id="amenity_name" name="amenity_name" required value="<?= htmlspecialchars($row['amenity_name']) ?>"></div>
                ...
                <div class="mb-4"><label for="price_per_use" class="form-label">Price per Use (₱)</label><input type="number" class="form-control" id="price_per_use" name="price_per_use" step="0.01" min="0" required value="<?= $row['price_per_use'] ?>"></div>
                <div class="d-flex gap-2"><button type="submit" class="btn btn-primary">Update Amenity</button><a href="amenities.php" class="btn btn-outline-secondary">Cancel</a></div>
            </form>
        </div>
    </div>
</div>
