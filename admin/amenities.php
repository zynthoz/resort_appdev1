...
<div class="main-content">
    <div class="page-header">
        <h1>Amenities</h1>
        <p>Manage resort amenities and services</p>
    </div>

    <?php if (isset($_GET['msg'])): ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <?php
            if ($_GET['msg'] == 'added') echo 'Amenity added successfully.';
            elseif ($_GET['msg'] == 'updated') echo 'Amenity updated successfully.';
            elseif ($_GET['msg'] == 'deleted') echo 'Amenity deleted successfully.';
            ?>
        ...
        <div class="table-header">
            ...
            <div class="table-actions">
                <form method="GET" class="search-form">
                    <input type="text" name="search" class="form-control" placeholder="Search amenities..." value="<?= htmlspecialchars($search) ?>">
                        ...
                        <tr>
                            <td colspan="4">
                                <div class="empty-state">
                                    ...
                                    <p>Add your first amenity to get started.</p>
                                    <a href="add_amenity.php" class="btn btn-primary btn-sm">+ Add Amenity</a>
                                </div>
                            </td>
                        </tr>
