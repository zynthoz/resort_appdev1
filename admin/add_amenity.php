...
<div class="main-content">
    <div class="page-header">
        <h1>Add Amenity</h1>
        <p>Create a new amenity or service</p>
    </div>
    ...
    <div class="form-card card">
        ...
        <div class="card-body">
            <form method="POST" action="">
                ...
                <div class="mb-4">
                    <label for="price_per_use" class="form-label">Price per Use (₱) <small class="text-muted">— set to 0 for free</small></label>
                    <input type="number" class="form-control" id="price_per_use" name="price_per_use" step="0.01" min="0" required>
                </div>
