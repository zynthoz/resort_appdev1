        ...
        <div class="card-body">
            <form method="POST" action="">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="package_name" name="package_name" required value="<?= htmlspecialchars($row['package_name']) ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="price" name="price" step="0.01" min="0" required value="<?= $row['price'] ?>">
                </div>
                <div class="mb-4">
                    <label for="inclusion_details" class="form-label">Inclusion Details</label>
                    <textarea class="form-control" id="inclusion_details" name="inclusion_details" rows="3"><?= htmlspecialchars($row['inclusion_details']) ?></textarea>
                </div>
